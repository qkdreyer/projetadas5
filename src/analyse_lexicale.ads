...
package Analyse_Lexicale is
   ...
   procedure TrieToListe_Txt1 (T : T_Trie; L : in out TListe_Couple; C : in String; F : in Natural);
   procedure TrieToListe_Txt2 (T : T_Trie; L : in out TListe_Triplet; C : in String; F : in Natural);
