...
package Liste_Triplet is
   ...
   -- Instanciation des fonctions relatives à l'insertion par ordre lexicographique du texte 1
   ...
   -- Instanciation des fonctions relatives à l'insertion par ordre lexicographique du texte 2
   ...
   -- Instanciation des fonctions relatives à l'insertion par nombre d'occurence décroissante du texte 1
   ...
   -- Instanciation des fonctions relatives à l'insertion par nombre d'occurence décroissante du texte 2
   ...
   -- Instanciation des fonctions relatives à l'insertion par somme du nombre d'occurence
