package body Liste_Triplet is
   ...
   begin
      return Get_NbOcc2(Triplet1)+Get_NbOcc1(Triplet1) > Get_NbOcc1(Triplet2)+Get_NbOcc2(Triplet2);
   ...
   begin
      ...
      New_Line;Put("Le mot ");Put(Get_Chaine(Get_Mot_T(T2)));Put(" a été supprimé");New_Line;
