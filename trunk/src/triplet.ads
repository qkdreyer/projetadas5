...
--Nous avons choisi d'utiliser cette structure pour r�pondre aux besoins de la R2 car nous voulions
--une structure proche de notre structure originale(couple). Nous avons donc uniquement rajout� une variable dans le
--record. 
